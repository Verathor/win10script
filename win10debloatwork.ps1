...
#
#     > iex(New-Object Net.WebClient).DownloadString('https://tinyurl.com/5f64m6dz')
#
#	Verathor Additions:
#
#	- Dark Mode
...
switch($createrestorepoint?){
	"" {CreateRestorePoint; break}
	y {CreateRestorePoint; break}
	yes {CreateRestorePoint; break}
	n {break}
	no {break}
}
...
$setdarkmode? = read-host "Do you want to set dark mode? [y/N]"

switch($setdarkmode?){
	"" {break}
	y {EnableDarkMode; break}
	yes {EnableDarkMode; break}
	n {DisableDarkMode; break}
	no {DisableDarkMode; break}
	default {write-host "Incorrect entry"; exit 1}
}
...
function UninstallThirdPartyBloat {
	...
	Get-AppxPackage "AD2F1837.HPSystemInformation" -allusers | Remove-AppxPackage -AllUsers
	Get-AppxPackage "AD2F1837.HPPCHardwareDiagnosticsWindows" -allusers | Remove-AppxPackage -AllUsers
	Get-AppxPackage "AD2F1837.HPPrivacySettings" -allusers | Remove-AppxPackage -AllUsers
	Get-AppxPackage "AD2F1837.HPJumpStarts" -allusers | Remove-AppxPackage -AllUsers
	Get-AppxPackage "AD2F1837.HPSupportAssistant" -allusers | Remove-AppxPackage -AllUsers
	Get-AppxPackage "AD2F1837.HPInc.EnergyStar" -allusers | Remove-AppxPackage -AllUsers
	...
	Get-AppxPackage "AD2F1837.HPInc.EnergyStar_1.2.0.0_x64__v10z8vjag6ke6" -allusers | Remove-AppxPackage -AllUsers
	Get-AppxPackage "AD2F1837.HPPrivacySettings_1.0.38.0_x64__v10z8vjag6ke6" -allusers | Remove-AppxPackage -AllUsers
...
Function EnableXboxFeatures {
	...
	Get-AppxPackage -AllUsers "Microsoft.XboxIdentityProvider" | ForEach-Object-Object {Add-AppxPackage -DisableDevelopmentMode -Register "$($_.InstallLocation)\AppXManifest.xml"}
