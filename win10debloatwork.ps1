...
function UninstallThirdPartyBloat {
	...
	Get-AppxPackage -AllUsers "AD2F1837.HPSureShieldAI" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "DB6EA5DB.Power2GoforDell" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "DellInc.DellSupportAssistforPCs" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "DellInc.DellDigitalDelivery" | Remove-AppxPackage
	Get-AppxPackage "-AllUsers DellInc.DellCommandUpdate" | Remove-AppxPackage
	Get-AppxPackage -AllUsers *booking.com* | Remove-AppxPackage
	...
	Get-AppxPackage -AllUsers "AD2F1837.HPInc.EnergyStar_1.2.0.0_x64__v10z8vjag6ke6" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "AD2F1837.HPPrivacySettings_1.0.38.0_x64__v10z8vjag6ke6" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "AD2F1837.HPJumpStarts_1.7.1464.0_x64__v10z8vjag6ke6" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "AD2F1837.HPJumpStarts_1.7.1464.0_x64__v10z8vjag6ke6" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "AD2F1837.HPSystemEventUtility_1.1.20.0_x64__v10z8vjag6ke6" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "AD2F1837.HPSupportAssistant_9.6.714.0_x64__v10z8vjag6ke6" | Remove-AppxPackage
	Get-AppxPackage -AllUsers "MixedRealityLearning_10.0.18362.449_neutral__cw5n1h2txyewy" | Remove-AppxPackage
